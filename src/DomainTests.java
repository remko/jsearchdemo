public class DomainTests
{
    ...
    public static void testAlgorithms() {
        ...
        g.addEdge(new WeighedEdge(S,C,9));
        g.addEdge(new WeighedEdge(S,B,8));
        g.addEdge(new WeighedEdge(S,E,10));
        g.addEdge(new WeighedEdge(D,B,4));
        g.addEdge(new WeighedEdge(B,G,5));
        g.addEdge(new WeighedEdge(E,D,1));
        g.addEdge(new WeighedEdge(C,G,5));
        g.addEdge(new WeighedEdge(S,G,3));
        g.removeEdge(new Edge(S,G));
        g.removeEdge(new Edge(S,G));
        g.setStartNode(S);
        g.setGoalNode(G);
