...
class GraphRenderer extends JPanel implements StateListener {
    ...
    */
	...
	if (n.getModel() == null)
	    return false;
	return n.getModel().equals(source.getStartNode());
    }
	
    boolean isGoalNode(NodeRenderer n) {
	if (n.getModel() == null)
	    return false;
	return n.getModel().equals(source.getGoalNode());
    }
	...
	WeighedEdge we = new WeighedEdge(from.getModel(), to.getModel(), DEFAULT_WEIGHT);
